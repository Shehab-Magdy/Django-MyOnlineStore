...
from .views import category, product, home, adminindex, errorPages
...
urlpatterns = [
    ...
    path('product/like/ajax/', home.addAjaxLike, name='likeProduct'),
    path('product/dislike/ajax/', home.removeAjaxLike, name='dislikeProduct'),
    ...
    url(r'^category/(?P<cat_id>\d+)/delete/$',
        category.delete, name='category_del'),
    path('category/create', category.create, name='category_addnew'),
    #path('category/save',category.save, name = 'category_save'),
    url(r'^category/(?P<cat_id>\d+)/update/$',
        category.update, name='category_update'),
    ...
    url(r'^product/(?P<prod_id>\d+)/delete/$',
        product.delete, name='product_del'),
    path('product/create', product.create, name='product_addnew'),
    #path('product/save',product.create, name = 'product_save'),
    url(r'^product/(?P<prod_id>\d+)/update/$',
        product.update, name='product_update'),
    #url(r'^product/(?P<prod_id>\d+)/save/$',product.update, name = 'product_saveupdate'),
    path('pageNotFound/', errorPages.pageNotFound, name='pageNotFound'),
]
